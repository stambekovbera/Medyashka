...
$limit = 1;
$offset = $limit * ($page - 1);
$dbContents = $mysql->query("SELECT * FROM `secondbook`");
$contents = array();
foreach ($dbContents as $content) {
    $contents[] = $content;
}
$totalPages = round(count($contents) / $limit, 0);

$limitContent = $mysql->query("SELECT * FROM `secondbook` LIMIT $limit OFFSET $offset");
$dbContent = mysqli_fetch_assoc($limitContent);
$contentObj = [
    "pageForeword" => $dbContent['pageForeword'],
    "forewordAuthor" => $dbContent['forewordAuthor'],
    "pageChapter" => $dbContent['pageChapter'],
    "pageTitle" => $dbContent['pageTitle'],
    "pageText" => $dbContent['pageText'],
    "pageImg" => $dbContent['pageImg'],
    "pageMessage" => $dbContent['pageMessage'],
];

if (isset($_COOKIE['userID'])) {
    $userID = $_COOKIE['userID'];
    $lastPage = $mysql->query("SELECT `secondBookLastPage` FROM `users` WHERE `users`.`id` = '$userID'");
    $last = mysqli_fetch_assoc($lastPage);
    if ($page > $last['secondBookLastPage']) {
        $mysql->query("UPDATE `users` SET `secondBookLastPage` = '$page' WHERE `users`.`id` = '$userID'");
    }
}
?>
...
<head>
    ...
    <link rel="stylesheet" href="css/secondBook.css">
    <link rel="stylesheet" href="css/header.css"/>
    <link rel="stylesheet" href="css/footer.css">
    <link rel="stylesheet" href="css/login.css">
    <title>Медяшка | Книга 2</title>
</head>
<body>
<?php
        ...
        <main class="main">
            ...
            <div class="container">
                <div class="main__inner">
                    <div class="main__inner-info-numbers">
                        <div class="main__inner-number">02 / 04</div>
                        <div class="main__inner-page"><?php echo $page; ?> / <?php echo $totalPages; ?></div>
                    </div>
                    <div class="main__inner-content">
                        <?php if (isset($contentObj['pageForeword'])) : ?>
                            <div class="main__inner-content-pageforeword">
                                <p><?php echo $contentObj['pageForeword']; ?></p>
                            </div>
                        <?php endif; ?>
                        <?php if (isset($contentObj['forewordAuthor'])) : ?>
                            <div class="main__inner-content-forewordauthor">
                                <p><?php echo $contentObj['forewordAuthor']; ?></p>
                            </div>
                        <?php endif; ?>
                        <?php if (isset($contentObj['pageChapter'])) : ?>
                            <div class="main__inner-content-pagechapter">
                                <p><?php echo $contentObj['pageChapter']; ?></p>
                            </div>
                        <?php endif; ?>
                        <?php if (isset($contentObj['pageTitle'])) : ?>
                            <div class="main__inner-content-pagetitle">
                                <h1><?php echo $contentObj['pageTitle']; ?></h1>
                            </div>
                        <?php endif; ?>
                        <div class="main__inner-content-text">
                            <?php if (isset($contentObj['pageImg'])) : ?>
                                <img class="main__inner-content-pageimg" src="<?php echo $contentObj['pageImg']; ?>"
                                     alt="">
                            <?php endif; ?>
                            <?php if (isset($contentObj['pageMessage'])) : ?>
                                <div class="main__inner-content-pagemessage">
                                    <p><?php echo $contentObj['pageMessage']; ?></p>
                                </div>
                            <?php endif; ?>
                            <?php if (isset($contentObj['pageText'])) : ?>
                                <div class="main__inner-content-pagetext">
                                    <p><?php echo $contentObj['pageText']; ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="main__inner-pagination">
                        <?php if ($page > 1): ?>
                            <a href="?page=<?php echo($page - 1); ?>" class="page-link">
                                <svg width="18" height="31" viewBox="0 0 18 31" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.5264 3.99872L3.70574 14.8193C3.31522 15.2099 3.31522 15.843 3.70574 16.2336L14.5264 27.0542"
                                          stroke="#6252B0" stroke-width="6" stroke-linecap="round"/>
                                </svg>
                            </a>
                        <?php endif; ?>
                        <p><span><?php echo $page ?></span> / <span><?php echo $totalPages ?></span></p>
                        <?php if ($page < $totalPages): ?>
                            <a href="?page=<?php echo($page + 1); ?>" class="page-link next">
                                <svg width="18" height="31" viewBox="0 0 18 31" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.52637 27.0542L14.347 16.2336C14.7375 15.8431 14.7375 15.2099 14.347 14.8194L3.52637 3.99874"
                                          stroke="#6252B0" stroke-width="6" stroke-linecap="round"/>
                                </svg>
                            </a>
                        <?php endif; ?>
            ...
            <div class="container">
                <div class="main__inner">
                    ...
                    <div class="main__inner-pagination">
                        ...
                        <?php endif; ?>
                        <p><span class="page"><?php echo $page ?></span> / <span><?php echo $totalPages ?></span></p>
                        <?php if ($page < $totalPages): ?>
                            <a href="?page=<?php echo($page + 1); ?>" class="page-link nextSecondBook">
                                <svg width="18" height="31" viewBox="0 0 18 31" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.52637 27.0542L14.347 16.2336C14.7375 15.8431 14.7375 15.2099 14.347 14.8194L3.52637 3.99874"
                                          stroke="#6252B0" stroke-width="6" stroke-linecap="round"/>
...
<script type="module" src="js/bookModules/setNewPage.js"></script>
