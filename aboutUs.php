        ...
        <main class="main">
            ...
            <div class="container">
                <div class="main__inner">
                    <h1 class="main__inner-title">О нас</h1>
                    <div class="main__inner-row">
                        <div class="main__inner-row-item">
                            <h2 class="title">Цель работы</h2>
                            <p>Бумажный вариант не совсем надёжен в хранении, а вот сами по себе электронные книги не
                                подвержены износу или старению. Благодаря публикации такой версии, есть возможность
                                быстрее распространять книгу среди пользователей. Сама по себе электронная книга – это
                                удобная, переформатированная книга, которая всего лишь преобразована в цифровой формат
                                для чтения на любом цифровом устройстве. Это и является нашей целью – упрощение
                                взаимодействия с книгой.</p>
                        </div>
                        <div class="main__inner-row-item">
                            <h2 class="title">Наша команда</h2>
                            <div class="main__inner-column">
                                <div class="main__inner-column-item">
                                    <div class="avatar">
                                        <img src="img/stambekovImg.png" alt="Стамбеков Берадор">
                                    </div>
                                    <div class="info">
                                        <h3 class="fullname">Стамбеков Берадор</h3>
                                        <p class="position">Backend разработчик</p>
                                        <p class="stack">MySQL, PHP</p>
                                    </div>
                                </div>
                                <div class="main__inner-column-item">
                                    <div class="avatar">
                                        <img src="img/jenishovImg.png" alt="Женишов Ислам">
                                    </div>
                                    <div class="info">
                                        <h3 class="fullname">Женишов Ислам</h3>
                                ...
                                <div class="main__inner-column-item">
                                    <div class="avatar">
                                        <img src="img/mezeninaImg.png" alt="Мезенина Арина">
                                    </div>
                                    <div class="info">
                                        <h3 class="fullname">Мезенина Арина</h3>
                                        <p class="position">UX/UI-дизайнер</p>
                                        <p class="stack">Photoshop, Illustrator, Figma</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="main__inner-row">
                        ...
                        <div class="main__inner-row-item">
                            ...
                            <div class="main__inner-column">
                                <div class="main__inner-column-item">
                                    <div class="avatar">
                                        <img src="img/stambekovImg.png" alt="">
                                    </div>
                                    <div class="info">
                                        <h3 class="fullname">Стамбеков Берадор</h3>
                                        <p class="position">Backend разработчик</p>
                                ...
                                <div class="main__inner-column-item">
                                    <div class="avatar">
                                        <img src="img/jenishovImg.png" alt="">
                                    </div>
                                    <div class="info">
                                        <h3 class="fullname">Женишов Ислам</h3>
                                        <p class="position">Frontend разработчик</p>
                                ...
                                <div class="main__inner-column-item">
                                    <div class="avatar">
                                        <img src="img/mezeninaImg.png" alt="">
                                    </div>
                                    <div class="info">
                                        <h3 class="fullname">Мезенина Арина</h3>
                                        <p class="position">UX/UI-дизайнер</p>
