...
$limit = 1;
$offset = $limit * ($page - 1);
$dbContents = $mysql->query("SELECT * FROM `thirdbook`");
$contents = array();
...
$limitContent = $mysql->query("SELECT * FROM `thirdbook` LIMIT $limit OFFSET $offset");
...
if (isset($_COOKIE['userID'])) {
    ...
    $lastPage = $mysql->query("SELECT `thirdBookLastPage` FROM `users` WHERE `users`.`id` = '$userID'");
    $last = mysqli_fetch_assoc($lastPage);
    if ($page > $last['thirdBookLastPage']) {
        $mysql->query("UPDATE `users` SET `thirdBookLastPage` = '$page' WHERE `users`.`id` = '$userID'");
    }
}
?>
            ...
            <div class="container">
                <div class="main__inner">
                    <div class="main__inner-info-numbers">
                        <div class="main__inner-number">03 / 04</div>
            ...
            <div class="container">
                <div class="main__inner">
                    ...
                    <div class="main__inner-pagination">
                        ...
                        <?php if ($page < $totalPages): ?>
                            <a href="?page=<?php echo($page + 1); ?>" class="page-link nextThirdBook">
                                <svg width="18" height="31" viewBox="0 0 18 31" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3.52637 27.0542L14.347 16.2336C14.7375 15.8431 14.7375 15.2099 14.347 14.8194L3.52637 3.99874"
                                          stroke="#6252B0" stroke-width="6" stroke-linecap="round"/>
